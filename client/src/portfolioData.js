const data = [
    ...
    },
    {
        ...
        description: "A monthly emagazine and its hosting site. The magazine is dsiplayed via a jQuery flipbook plugin. The site also displays information on the various subscription plans, a way to buy subscriptions using Stripe, an account management page, and an about/contact page. Note: The site was decommissioned at the client's request.",
